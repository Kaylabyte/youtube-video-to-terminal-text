...
def frame_convert(frame, scale, char_full, char_empty):
...
def video_convert(video_mp4, scale, char_full, char_empty):
    ...
    while success: # loops through all the frames
        video_terminal.append(frame_convert(frame, scale, char_full, char_empty))
        success, frame = video_capture.read()
